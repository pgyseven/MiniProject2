...
<script>
	...
	function removeFile() {
		...
		$.each(removeFilesArr, function(i, item) {
         $.ajax({
            url : '/rboard/modifyRemoveFileCheck',            
            type : 'post',            
            dataType : 'json',           
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-info"
							onclick="location.href='/rboard/removeBoard?boardNo=${param.boardNo}';">삭제</button>
